...
3. Run the script from the command line:
    ...
    python K_means_clustering_for_state_crimes.py

4. After execution, you should see a message like:
...
The original data are documented as "Violent Crime Rates by US State, 1973" and are widely distributed as part of the R base datasets.
